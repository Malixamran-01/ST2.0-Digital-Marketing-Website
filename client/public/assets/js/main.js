(function ($) {
  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    // Normalize menus to single Home variant across all pages
    function replaceMenus() {
        ...
        var mobileMenu = document.querySelector('.th-mobile-menu > ul');
        if (mobileMenu) {
        ...
        // Remove any mega menus that were attached to Home
        document.querySelectorAll('.mega-menu, .mega-menu-content').forEach(function(el){ el.remove(); });
    }

    $(document).ready(function () {
        replaceMenus();
        // Speed up preloader removal to improve LCP
        setTimeout(function () {
        ...
        try {
            var heroImg = document.querySelector('.th-hero-wrapper img');
            if (heroImg) {
            ...
            document.querySelectorAll('img').forEach(function (img) {
                if (img.closest('.th-hero-wrapper') || img.closest('.header-logo')) return;
    ...
    if ($('[data-theme-color]').length > 0) {
        $('[data-theme-color]').each(function () {
            ...
            // Force global brand red if yellow was specified
            if ($color === '#FED91F') { $color = '#d71920'; }
